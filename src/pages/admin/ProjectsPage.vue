...
const { projects, loading, error, pagination, fetchProjects, applyFilters, deleteProject } =
  useProjects()
...
<template>
  <div class="page">
    ...
    <div class="filters">
      ...
      />
      <select v-model="searchStatus" class="filters__select" aria-label="Filter by status" @change="handleSearch">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr v-for="project in projects" :key="project.id">
              ...
              <td>
                <div class="tags">
                  <span v-for="tech in project.technologies.slice(0, 3)" :key="tech" class="tag">{{
                    tech
                  }}</span>
                  <span v-if="project.technologies.length > 3" class="tag tag--more"
